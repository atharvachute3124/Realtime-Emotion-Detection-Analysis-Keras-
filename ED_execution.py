...
y_train = np.array(train_y,'float32')
X_test = np.array(X_test,'float32')
y_test = np.array(test_y,'float32')

y_train = np_utils.to_categorical(train_y, num_classes=num_labels)
y_test = np_utils.to_categorical(test_y, num_classes=num_labels)
